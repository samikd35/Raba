...
export class BMCService {
  ...
  async fetchBMCData(
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/v2/mvp/projects/${projectId}/bmc`, 
      {
        method: 'GET',
        headers: {
  ...
  async generateBMC(
    ...
    if (process.env.NODE_ENV === 'development') {
      ...
      console.log('🔄 Request URL:', `${process.env.NEXT_PUBLIC_API_URL}/api/v2/mvp/projects/${projectId}/bmc/generate`);
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/v2/mvp/projects/${projectId}/bmc/generate`, 
      {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
   ...
   * PUT /api/v2/mvp/projects/{project_id}/bmc/v2/blocks/{block_name}
   */
  async editBlock(
    projectId: string,
    token: string,
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/v2/mvp/projects/${projectId}/bmc/blocks/${blockName}`,
      {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
   ...
   * POST /api/v2/mvp/projects/{project_id}/bmc/v2/items/add
   */
  async addItem(
    projectId: string,
    token: string,
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/v2/mvp/projects/${projectId}/bmc/items/add`,
      {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
   ...
   * DELETE /api/v2/mvp/projects/{project_id}/bmc/v2/items/delete
   */
  async deleteItem(
    projectId: string,
    token: string,
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/v2/mvp/projects/${projectId}/bmc/items/delete`,
      {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
