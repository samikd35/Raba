  ...
  >
    {isDownloading ? (
      ...
      <>
        ...
        <span className="hidden lg:inline">Save as Image</span>
                ...
                <Button
                  onClick={(e) => {
                    ...
                    btn.disabled = true;
                    router.push(`/workspace/value-map/${projectId}`);
                  }}
                  data-loading="false"
                  variant="default"
              ...
              <motion.div variants={itemVariants} className="order-2 xl:order-1 flex items-center justify-center ">
                <div className="relative flex items-center justify-center p-2 rounded-2xl">
                  ...
                  <div className="grid grid-cols-2 grid-rows-2 gap-2">
                    ...
                    <div className="col-span-2 row-span-2 rounded-t-2xl border-2 transition-all duration-300 group  bg-green-50 dark:bg-green-900/10 border-green-200 dark:border-green-800">
                            ...
                            if (items.length > 0) {
                              return (
                                <div className="space-y-2 flex flex-col items-center justify-center pb-4">
                                  {items.map((item, idx) => (
                                    <div key={item.id} className="px-3 py-2 bg-white/70 dark:bg-gray-800/70 rounded-lg border border-green-200 dark:border-green-700 flex items-center justify-center w-[300px]">
                    ...
                    <div className="absolute top-[44%] left-1/2 -translate-x-1/2 xl:top-[44%] xl:left-[42%] xl:translate-x-0 z-10">
                      <SectionOverlayLabel text="Value Map" />
                    </div>
                    {/* Pain Relievers - Bottom Left */}
                    <div className="col-span-1 row-span-1 rounded-bl-2xl border-2 transition-all duration-300 group p-4 bg-red-50 dark:bg-red-900/10 border-red-200 dark:border-red-800">
                      <div className="p-4 h-full flex flex-col items-center justify-center">
                        <div className="flex items-center gap-4 mb-4 justify-center">
                          <div className="p-2 rounded-lg bg-red-200/60">
                            ...
                            if (items.length > 0) {
                              return (
                                <div className="space-y-1">
                                  {items.map((item, idx) => (
                                    <div key={item.id} className="px-3 py-2 bg-white/70 dark:bg-gray-800/70 rounded-lg border border-red-200 dark:border-red-700 flex items-center justify-center w-[250px]">
                                      <p className="text-sm font-medium text-gray-800 dark:text-white">{item.label}</p>
                    ...
                    <div className="col-span-1 row-span-1 rounded-br-2xl border-2 transition-all duration-300 group p-4 bg-blue-50 dark:bg-blue-900/10 border-blue-200 dark:border-blue-800">
                      <div className="p-4 h-full flex flex-col">
                        <div className="flex items-center gap-4 mb-4 justify-center">
                          <div className="p-2 rounded-lg bg-blue-200/60">
                          ...
                          {(() => {
                            ...
                            if (items.length > 0) {
                              return (
                                <div className="space-y-1">
                                  {items.map((item, idx) => (
                                    <div key={item.id} className="px-3 py-2 bg-white/70 dark:bg-gray-800/70 rounded-lg border border-blue-200 dark:border-blue-700 flex items-center justify-center w-[250px]">
                                      <p className="text-sm font-medium text-gray-800 dark:text-white">{item.label}</p>
                      ...
                      <div className="flex flex-col gap-1 -mt-2">
                        {getSectionData('jobs').items.map((item, index) => (
                          <motion.div
                            ...
                            className="p-2 bg-white dark:bg-gray-800 rounded-lg border border-green-200 dark:border-green-700 px-4"
                          >
                      ...
                      <div className="flex flex-col items-end space-y-1 -mt-3">
                        {getSectionData('pains').items.map((item, index) => (
                          <motion.div
                            ...
                            className="p-2 bg-white dark:bg-gray-800 rounded-lg border border-red-200 dark:border-red-700 w-50"
                          >
                      ...
                      <div className="flex flex-col items-start space-y-1 -mt-3">
                        {getSectionData('gains').items.map((item, index) => (
                          <motion.div
                            ...
                            className="p-2 bg-white dark:bg-gray-800 rounded-lg border border-blue-200 dark:border-blue-700 w-52"
                          >
                            <div className="flex items-center justify-center">
                              <p className="text-sm font-medium text-gray-800 dark:text-white">
                                {item.label}
                    ...
                    >
                      <div className="p-6">
                        <div className="flex items-center gap-4">
                          <div className={`p-4 rounded-xl transition-all duration-300 bg-green-200 dark:bg-green-800/30 ${
        ...
        >
          <Button
            onClick={() => router.push(`/workspace/customer-profile/${projectId}`)}
            variant="outline"
