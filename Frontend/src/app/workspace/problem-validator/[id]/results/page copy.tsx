  ...
  return (
    <div className="bg-white dark:bg-[#101828] ">
      {/* <FeatureVideoOverlay
        ...
        buttonClassName="bottom-24 right-6"
      /> */}
      ...
      <Button
        ...
        className="shadow-lg hover:bg-brand-400 rounded-lg h-10 px-8 flex items-center justify-center gap-2 hover:scale-105 transition-transform"
...
>
  ...
  <div className="w-24"></div>
      ...
      >
        <div className="flex items-center justify-center py-4 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-t border-brand-100 dark:border-brand-800 shadow-lg">
          <div className="flex gap-4 justify-center px-4">
            ...
            <Button onClick={openCreateProjectModal} className="bg-brand-600 hover:bg-brand-700">
              Advance to module 2
            </Button>
          </div>
        </div>
      ...
      <div className="fixed bottom-8 right-8 z-40">
        <Button 
          onClick={openChatbot} 
          className="bg-brand-500 text-white hover:scale-120 hover:bg-brand-600 shadow-lg transition-all duration-300 flex items-center justify-center p-4 rounded-full h-14 w-14"
