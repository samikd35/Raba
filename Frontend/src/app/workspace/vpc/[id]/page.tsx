        ...
        {isFullscreen && (
          <div>
            ...
            >
              ...
              <motion.div variants={itemVariants} className={`order-1 xl:order-2 grid grid-cols-2 gap-2 rounded-full p-2 mx-auto ${isFullscreen ? 'h-[600px] w-[600px]' : 'h-[450px] w-[450px]'}`}>
                  
                  {/* Jobs-to-be-Done Section */}
                  <Card className="col-span-2 p-2 border-2 grid grid-cols-1 border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/10 rounded-t-full flex justify-center items-center h-full row-span-1 hover:scale-[1.01] transition-all duration-300 cursor-pointer">
          ...
          <>
            ...
            >
              ...
              <motion.div 
                ...
                className="order-1 xl:order-2 relative w-full flex flex-col items-center justify-center"
                onMouseLeave={() => setHoveredCustomerSection(null)}
              >

                  
                  <div className="relative grid grid-cols-2 gap-2 rounded-full p-2 mx-auto h-[450px] w-[450px]">
                  {/* Jobs-to-be-Done Section */}
                  <Card 
        ...
        >
          ...
          <Button
            onClick={() => {
              ...
              router.push(`/workspace/assumptions/${projectId}`);
            }}
