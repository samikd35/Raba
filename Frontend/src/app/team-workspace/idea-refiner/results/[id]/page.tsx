...
export default function IdeaRefinementResults() {
  ...
  const featureConfig = getFeatureVideoConfig(FEATURE_IDS.IDEA_REFINER);

  // Constants for maintainability - memoized to prevent recreation
  const constants = useMemo(() => ({
    ANIMATION_DELAY_BASE: 0.5,
    ANIMATION_DELAY_INCREMENT: 0.1,
    REFINER_ROUTE: '/team-workspace/idea-refiner',
    VALIDATOR_ROUTE: '/team-workspace/problem-validator',
    STORAGE_KEYS: {
  ...
  return (
    <div className="relative flex flex-col overflow-x-hidden ">
      {/* <FeatureVideoOverlay
        featureId={FEATURE_IDS.IDEA_REFINER}
