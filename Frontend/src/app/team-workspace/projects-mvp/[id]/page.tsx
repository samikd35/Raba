                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900 dark:text-white mb-2">
                              Customer Pains ({persona.customer_profile.pains.length})
                            </h4>
                            <div className="space-y-2">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900 dark:text-white mb-2">
                              Customer Jobs ({persona.customer_profile.jobs_to_be_done.length})
                            </h4>
                            <div className="space-y-2">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900 dark:text-white mb-2">
                              Customer Gains ({persona.customer_profile.gains.length})
                            </h4>
                            <div className="space-y-2">
