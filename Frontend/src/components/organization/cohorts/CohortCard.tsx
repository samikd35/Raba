...
import { Calendar, Clock, Loader2, CheckCircle2, XCircle } from 'lucide-react';
...
export const CohortCard = React.memo(({ cohort, index, path }: CohortCardProps) => {
                    ...
                    {isNavigating && (
                        <div className="absolute inset-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm flex items-center justify-center z-10">
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <span className="text-xs text-gray-600 dark:text-gray-400 font-medium">Opening...</span>
                            </div>
                        </div>
                    )}
                </Card>
