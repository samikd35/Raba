...
interface ProjectsProjectChatComponentProps {
 ...
 */
export const ProjectsProjectChatComponent: React.FC<ProjectsProjectChatComponentProps> = ({ path = 'team-workspace' }) => {
  ...
  const loadProjects = useCallback(async (forceRefresh = false) => {
    ...
    try {
      ...
      const response = await fetchCompletedValueMaps(abortControllerRef.current.signal);
