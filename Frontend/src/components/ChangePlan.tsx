      ...
      <DialogContent>
        ...
        <form className="space-y-5">
          <RadioGroup className="gap-2" defaultValue="2">
            ...
            {/* Radio card #2 */}
            <div className="border-input has-data-[state=checked]:border-brand-50 has-data-[state=checked]:bg-brand-25 relative flex w-full items-center gap-2 rounded-md border px-4 py-3 shadow-xs outline-none">
              <RadioGroupItem
                value="2"
                id={`${id}-2`}
