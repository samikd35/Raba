    ...
    const getStatusConfig = (status: string) => {
        switch (status) {
            ...
            case 'research_complete':
                return { color: 'bg-sky-500/15 text-sky-500 border-sky-500/20', icon: CheckCircle2, label: 'Research Complete' }
            case 'script_complete':
                return { color: 'bg-indigo-500/15 text-indigo-500 border-indigo-500/20', icon: CheckCircle2, label: 'Script Complete' }
            case 'image_complete':
                return { color: 'bg-cyan-500/15 text-cyan-500 border-cyan-500/20', icon: CheckCircle2, label: 'Images Complete' }
            case 'pending':
