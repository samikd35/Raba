  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div
              className="ml-1 cursor-pointer flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg transition-colors duration-200 group hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white"
