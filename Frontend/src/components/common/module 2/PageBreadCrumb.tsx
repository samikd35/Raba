...
const PageBreadcrumb: React.FC<BreadcrumbProps> = ({ pageTitle, titleSuffix }) => {
  ...
  const isVMPPage = (): boolean => {
    const vmpPages = [
      ...
      'hypothesis', 'assumptions', 'questionnaires', 'generate-customer-profile', 'market-research-upload', 'market-research-analysis'
    ];
  ...
  return (
    <div className="sticky top-[65px] z-40 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
      <div className="flex items-center bg-white dark:bg-gray-900 justify-between px-4 py-3 max-w-full">
        {/* Page Title Section */}
